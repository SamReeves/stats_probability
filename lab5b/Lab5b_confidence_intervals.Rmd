...
If the other student sets the random seed to 1337, then I would expect the sampling to be identical.  Otherwise, the sample may be similar but very unlikely to be the same.
...
It means that we are 95% certain that we have captured the true population proportion inside of our lower and upper bounds.
...
Umm, surprisingly, 62% is outside of the bootstrapped interval 33% - 58%.
...
I would expect about 95% of the students to capture the true population mean because of the nature of the confidence interval.  It would make sense that some would fall outside, as there is variance in the sampling process.  As sample size approaches the total population, standard error would approach zero.
...
https://github.com/TheWerefriend/data606/raw/main/lab5b/ci1.png

![](ci1.png)

In our plot above, we have 48/50 bootstrapped intervals containing the actual population proportion.  This is close enough to the confidence interval we had intended (96% vs. 95%) that I would say, yes, this experiment went exactly as expected.
...
If we choose a confidence interval of 99%, the interval will be much wider.  We are in this case 99% sure we have captured the correct statistic inside the bounds.  If we choose a 65% interval, the area under the curve between the bounds will be considerably narrower, as there is a greater chance for the desired population statistic to fall outside of our selection.
...
There is 75% chance that the actual population proportion of people who believe climate change affects their community is between 0.383 and 0.517.

### 3.  Using the app, calculate 50 confidence intervals at the confidence level you chose in the previous question, and plot all intervals on one plot, and calculate the proportion of intervals that include the true population proportion.  How does this percentage compare to the confidence level selected for the intervals?

https://github.com/TheWerefriend/data606/raw/main/lab5b/ci2.png

![](ci2.png)

34 / 50 = 68%

This is substantially less effective than the confidence interval of 75% we selected.
...
Let's try 99%.  I expect the lower and upper bounds of this interval to be considerably wider than the other intervals, and I expect the proportion of intervals which actually contain the population proportion of 62% to more closely reflect the chosen confidence.
...
https://github.com/TheWerefriend/data606/raw/main/lab5b/ci3.png

![](ci3.png)

Only one out of 50 intervals did not contain the target statistic.  Our suspicions are confirmed.
...
Changing the sample sizes has a great impact on the widths of the intervals.  With a sample size of ten, the interval width is 50%, and with a sample size of 5000, the interval shrinks to about 3%.

### 6.  Finally, given a sample size (say, 60), how does the width of the interval change as you increase the number of bootstrap samples. **Hint:** Does changing the number of bootstap samples affect the standard error?

It would appear that setting a high number of resamples decreases the standard error significantly.
